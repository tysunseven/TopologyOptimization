function [m, n, xold1, xold2, low, upp, a0, a, c_MMA, d, move] = init_mma(nelx, nely, x, const)
% 优化参数初始化函数
% 输入参数:
%   nelx - X方向单元数
%   nely - Y方向单元数
...
c_MMA = const*ones(m,1);   % Column vector with the constants c_i in the terms c_i*y_i.
